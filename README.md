<p align="center">
  <a href="https://bClass.bik.run/">
    <img src="./icon/bClass theme-css.svg" alt="Logo" width="220" height="auto">
  </a>
...
A comprehensive library for developing interfaces to websites and applications.

> [!NOTE]
> It is developed to be used in [bik.run](https://bik.run) services and systems within the scope of bClass theme css [birlik project](https://project.birlik.run). You are free to use it under the license.
